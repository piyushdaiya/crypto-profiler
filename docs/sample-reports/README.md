...
- Demonstrates: trace-aware Ethereum Layer 1 reporting, labeled high-risk infrastructure, and internal-call context in the report surface.
- Demo command:
...
- Demonstrates: UTXO-flow language, spend-heavy operational behavior, and broad but structured Bitcoin counterparty surfaces.
- Demo command:
...
- Demonstrates: token-surface breadth, trusted protocol context, repeated counterparty activity, and ERC-20 Layer 1 report framing.
- Demo command:
