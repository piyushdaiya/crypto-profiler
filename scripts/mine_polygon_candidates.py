...
DEFAULT_DATASET = "bigquery-public-data.goog_blockchain_polygon_mainnet_us"
DEFAULT_LIMIT = 1000
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Mine Polygon candidates from BigQuery")
...
def main() -> None:
    ...
    manifest = {
        "script": "mine_polygon_candidates.py",
