...
# scripts/summarize_arbitrum_transactions_parquet.py
#!/usr/bin/env python3
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize exported Arbitrum transaction parquet files")
...
def main() -> None:
    ...
    manifest = {
        "script": "summarize_arbitrum_transactions_parquet.py",
